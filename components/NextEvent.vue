<template>
  <div class="next-event">
    ...
    <div v-for="(nextEventGroup, key) in nextEvents" :key="key" class="wrapper">
      <div class="logo-wrapper">
        <a :href="nextEventGroup.nextEvent.url">
          <img :src="nextEventGroup.logo" :alt="nextEventGroup.name" class="member-logo">
        </a>
      </div>
