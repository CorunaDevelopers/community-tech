<template>
  <div>
    <div v-if="video.player== 'youtube'">
      <a v-if="preferExternal" :href="`//www.youtube.com/watch?v=${video.id}`" target="_blank">
    ...
    <div v-if="video.player == 'native'" class="video-player-container">
      <no-ssr>
        <div
    ...
    <div v-if="video.player== 'teltek'" class="embed-responsive embed-responsive-16by9">
      <iframe
